...
def get_credit_card_info(card_number):
    ...
    return {
        "Luhn Algorithm Check": luhn_algorithm_check(card_number),
        "MII (Major Industry Identifier)": mii + " - " + mii_categories.get(mii, "Unknown Category"),
        "Bank Name": bank_name,
        "Bank Country": bank_country,
        "BIN/IIN (Bank/Issuer Identification Number)": bin_iin,
...
| $$    $$| $$    $$      | $$    $$| $$  | $$| $$_____/| $$      | $$_  $$ 
|  $$$$$$/|  $$$$$$/      |  $$$$$$/| $$  | $$|  $$$$$$$|  $$$$$$$| $$ \  $$
 \______/  \______/        \______/ |__/  |__/ \_______/ \_______/|__/  \__/
                Made by PersonalPr0xy | dsc.gg/Pr0xyArmyFans\n
""")
credit_card_number = input("Paste card: ")
